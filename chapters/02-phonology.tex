...
There are few lexemes where the vowels /ə/ or /o/ is short (see the note “\ref{bkm:Ref347176670}.” of \tabref{tab:key:4}). There are reasons to believe that they are underlyingly /əə/ or /oo/ (see §\ref{bkm:Ref301832441}).
...
\ea Phonotactic constraints (or tendencies):
\ea Non-nasal resonants cannot be followed by approximants, i.e., /*rj/, /*jj/, and /*wj/ (see \sectref{sec:key:8.2.1.3});
...
\ex The consonants that can precede /w/ filled in G slot are only /kˀ/, /k/ and /h/ (\tabref{tab:key:18} in \sectref{sec:key:2.3.2.5});
\z
\z
...
{b} &  \multicolumn{2}{l}{{jurukubjaganaa (glad.SIM)}}  &    {asɨbjur}  {(play.UMRK)}            \\
...
{c}  {cjaa}  {‘tea’}      {cjukaa}  {‘kettle’}  {kacjɨ}  {(write.SEQ)} & \multicolumn{2}{l}{{məəhucjəə ‘forehead’}} & {cjoo}  {‘just’}\\
{cˀ}  {cˀjan}  {‘father’}      {cˀju}  {‘person’}  {cˀjɨ}  {(come.SEQ)} & \multicolumn{2}{l}{{cˀjəəra (come.SEQ.after)}} &  {cˀjoo}  {(person.TOP)}\\
...
{h}          {hjuusɨ}  {‘bulbul’}            \\
{m}  {mjaa}  {‘cat’}  & \multicolumn{2}{l}{{mjicja (see.PST)}} &  {mjuuna}  {(see.PROH)}  {mjɨ}  {(see.IMP)}      {mjoo}  {(see.INT)}\\
{n}  {kəənja}  {‘arm’}      {kinju}  {‘yesterday’}  {njɨɨ}  {‘load’}  {hannjəə}  {‘grandmother’}  & \multicolumn{2}{l}{{anjoo ‘elder brother’}}\\
