...
\subsubsection{Adnominal clause}
...
\subsubsection{Complement clause}
...
\subsubsection{\textit{{}-tɨ} (SEQ) as insubordination}
...
\lspbottomrule
\end{tabularx}
\subsubsection{\textit{{}-ba} (CSL) as the insubordination}
