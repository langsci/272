...
eat-\textsc{neg}=\textsc{fn}=\textsc{top}  good-\textsc{adj}  \textsc{stv}-NEG\\
...
\ea\label{ex:6-126}
 \textbf{a.}  {\TM}  naakjaa  anmataaja  kuinu  kjurasa  atɨ\\##\textit{naakja-a}  \textit{anmaa-taa=ja}  \textit{kui=nu}  \textit{kjura-sa}  \textit{ar-tɨ}
      ...
      [2.\textsc{hon}.\textsc{pl}-\textsc{adnz}  mother-\textsc{pl}]=\textsc{top}  voice=\textsc{nom}  beautiful-\textsc{adj}  \textsc{stv}-\textsc{seq}
...
\glt ‘Did your mother have a beautiful voice?’ [El: 130816]
  ...
  \textbf{b.}  {\TM}  \textsuperscript{\#}an  warabəə  kuinu  kjurasa  atɨ
       ...
       [\textsc{dist}-\textsc{adnz}  child=\textsc{top}]  voice=\textsc{nom}  beautiful-\textsc{adj}  \textsc{stv}-\textsc{seq}
...
\ea\label{ex:6-129}
 \textbf{a.}  {\TM}  an  sinsjeija  kanɨga  atɨ  mooransjutɨ,\\##\textit{a-n}  \textit{sinsjei=ja}  \textit{kanɨ=ga}  \textit{ar-tɨ}  \textit{moor-an=sjutɨ}
      ...
      small-\textsc{adj}+\textsc{stv}-\textsc{ptcp}  house=\textsc{loc}  live-\textsc{seq}  \textsc{hon}-\textsc{umrk}-PTCP=\textsc{qt}\\
