...
cold  draw-\textsc{inf}+easy-\textsc{adj}  \textsc{st}V-\textsc{csl}  \textsc{mes}-\textsc{advz}  do-\textsc{seq}  \textsc{cop}-\textsc{seq}   outside+vicinity  walk-\textsc{neg}=after=\textsc{sol}\\
...
rice=\textsc{appr}=\textsc{nom}  exist-\textsc{neg}-\textsc{cnd}  eat-\textsc{seq}=\textsc{nom}  go-NEG=\textsc{csl}\\
...
\glll gan  jiccjan  mun  həəku  tutɨ   konboo,  cˀjun  tɨmɨrarɨɨdoocjɨ  jˀicjanmun,\\
      ...
      \textsc{mes}-\textsc{advz}  good-\textsc{adf}+\textsc{st}V-\textsc{ptcp}  thing  early-\textsc{advz}  take-\textsc{seq} come-\textsc{neg}-\textsc{cnd}  person=\textsc{dat}1  find-P\textsc{ass}-\textsc{inf}=ASS  say-\textsc{pst}-\textsc{ptcp}=\textsc{advrs}\\
...
Usato+aunt=\textsc{nom}  exist-\textsc{inf}=\textsc{dat}1=\textsc{top}  very  good-\textsc{adj}  \textsc{st}V-\textsc{pst}-\textsc{ptcp}=\textsc{advrs}=\textsc{qt}=\textsc{cfm}1\\
...
small-\textsc{adj}+\textsc{st}V-\textsc{inf}-time=\textsc{top}  2.\textsc{hon}=\textsc{com}=\textsc{top}  play-\textsc{neg}-\textsc{pst}=\textsc{sol}\\
...
[Hamaitsu+grandfather=\textsc{com}  1\textsc{pl}-\textsc{adnz}  Torataro+grandfather=\textsc{com}=\textsc{foc}]
...
[\textsc{prox}-\textsc{adnz}  person=\textsc{com}  \textsc{prox}-\textsc{adnz}  person=\textsc{com}]
...
\textsc{dist}-\textsc{nlz}=\textsc{nom}  Shizu+grandmother=\textsc{nom}  exist-\textsc{cnd}  good-\textsc{adj}
...
\textsc{dist}-\textsc{nlz} =\textsc{gen}  younger.sibling=\textsc{loc1}  Masuo=\textsc{qt}  say-\textsc{seq}
...
\textit{wan=ja}  \textit{a-ma=nan}/\textit{a-ma=nantɨ}/\textit{a-ma=zjɨ}  \textit{wur-oo=jəə}\\
    ...
    1\textsc{sg}=\textsc{top}  \textsc{dist}-place=\textsc{loc1}/DI\textsc{st}-place=\textsc{loc2}/DIST-place=\textsc{loc3}  exist-\textsc{int}=\textsc{cfm}2
...
\textit{tɨgan=ja}  \textit{a-ma=nan=du}/\textit{a-ma=nantɨ=du}/\textit{a-ma=zjɨ=du}\\
    ...
    letter=\textsc{top}  \textsc{dist}-place=\textsc{loc1}=\textsc{foc}/DI\textsc{st}-place=\textsc{loc2}=\textsc{foc}/DIST-place=\textsc{loc3}=\textsc{foc}
...
\textit{a-ma=nan}/\textit{a-ma=nantɨ}/\textit{a-ma=zjɨ}  \textit{wudur-oo=jəə}\\
    ...
    \textsc{dist}-place=\textsc{loc1}/DI\textsc{st}-place=\textsc{loc2}/DIST-place=\textsc{loc3}  dance-\textsc{int}=\textsc{cfm}2
...
1-\textsc{sg}=\textsc{top}  know-\textsc{neg}  1-\textsc{pl}=\textsc{top}  know-NEG=\textsc{ass}\\
...
\textit{u-rɨ=ja}  \textit{mucɨkasj-sa=nu}  \textit{waa-kja=ja}  \textit{cˀjui=sjɨ=ja}\\
    ...
    \textsc{mes}-\textsc{nlz}=\textsc{top}  difficult-\textsc{adj}=\textsc{csl}  1-\textsc{pl}=\textsc{top}  one.person.\textsc{clf}=\textsc{inst}=\textsc{top}
...
Yoneshige-\textsc{pl}  father=\textsc{com}  \textsc{dist}-\textsc{nlz}-PL  grandfather=\textsc{com}=\textsc{nom}=\textsc{cfm}1
...
chief.of.a.ward-\textsc{hon}=\textsc{gen}  below=\textsc{loc1}  again  \textsc{dist}-\textsc{nlz}-\textsc{pl}=\textsc{top}
...
\glll uttaaga  {\textbar}sansankudo{\textbar}  sjun  turonkjanu\\
      ...
      \textsc{mes}-\textsc{nlz}-\textsc{pl}=\textsc{nom}  k.o.ritual  do-\textsc{prog}-\textsc{ptcp}  place=\textsc{appr}=\textsc{nom}
...
\glll ziinu  micjanu  naanan  dɨkɨjun  munna\\
      ...
      ground=\textsc{gen}  soil=\textsc{gen}  inside=\textsc{loc1}  be.born-\textsc{umrk}-\textsc{ptcp}  thing=\textsc{top}
...
2.\textsc{nhon}.\textsc{pl}-\textsc{adnz}  house=\textsc{nom}  above=\textsc{gen}  house=\textsc{nom}
...
\glll arɨnkjanu  huccjunu  sjasinnan\\
      ...
      \textsc{dist}-\textsc{nlz}=\textsc{appr}=\textsc{gen}  old.person=\textsc{gen}  photo=\textsc{loc1}
...
\glll dusinkjanu  zikinu  {\textbar}itoko{\textbar}nu  muhacianjootaa,\\
      ...
      \textsc{dist}-\textsc{nlz}-\textsc{pl}=\textsc{appr}=\textsc{top}  Tsuneko=\textsc{qt}=\textsc{app}R=\textsc{top}  say-\textsc{pst}-\textsc{ptcp}
...
\glll atoora  nobuariga  jappai  {\textbar}kaacjan{\textbar}ga  jˀicjan\\
      ...
      after=\textsc{abl}  Nobuari=\textsc{nom}  after.all  mother=\textsc{nom}  say-\textsc{pst}-\textsc{ptcp}
...
\glll nobuaritaaga,  joo,  naikwoo ..  ujaja  ujacjɨ  joo ..\\
      ...
      Nobuari-\textsc{pl}=\textsc{nom}  \textsc{fil}  a.little=\textsc{top}  parent=\textsc{top}  parent=\textsc{qt}  \textsc{fi}L
...
\glll namanu  cjoodo  an ...  kˀurusan\\
      ...
      butterfly=\textsc{nom}    \textsc{dist}-\textsc{nlz}=\textsc{nom}  exist-\textsc{ptcp}=\textsc{qt}=\textsc{cfm}1\\
...
big+tree=\textsc{nom}  exist-\textsc{seq}  \textsc{mes}-\textsc{adnz}=\textsc{loc2}  man=\textsc{nom}  ladder
...
\textsc{dist}-\textsc{nlz}=\textsc{nom}  exist-\textsc{ptcp}=\textsc{qt}=\textsc{cfm}1  DI\textsc{st}-NLZ=\textsc{nom}
...
If the predicate expresses non-existence, the core arguments frequenly choose \textit{ga} (\textsc{nom}). In other words, if the predicate is filled by any one of these, i.e. \textit{wur-an} (exist-\textsc{neg}), \textit{nə-n} (exist-NEG), \textit{umoor-an} (exist.\textsc{hon}-NEG), or \textit{ar-tɨ} \textit{moor-an} (exist-\textsc{seq} \textsc{hon}-NEG), the core arguments tend to choose \textit{ga} (\textsc{nom}). The “core arguments” here tend to be the subjects of the clauses, but sometimes it is difficult to call them subjects as in (\ref{ex:6-129}a-b), where the subjects are \textit{a-n} \textit{sinsjei} ‘that teacher’ or \textit{a-n} \textit{warabɨ} ‘that child,’ and not \textit{kanɨ} ‘money’.
...
\textsc{prox}-place=\textsc{loc1}=\textsc{top}  \textsc{dist}-\textsc{nlz}=\textsc{nom}  exist-\textsc{neg}-\textsc{pst}-\textsc{csl}=\textsc{sol}
...
\textsc{mes}-\textsc{adnz}  child=\textsc{nom}  one.\textsc{clf}=\textsc{gen}  child=\textsc{nom}  whistle
...
hey  \textsc{mes}-place=\textsc{loc1}  Motoyama=\textsc{nom}  borrow  close-\textsc{rsl}-\textsc{pst}-\textsc{csl}

      katɨ,  unnən  nunkuin.

      \textit{kar-tɨ}  \textit{u-n=nən}  \textit{nuu-nkuin}

      borrow-\textsc{seq}  \textsc{mes}-\textsc{adnz}=\textsc{loc1}  what-\textsc{indf}\\
...
\textit{u-n=nəntɨ}  \textit{uzii=ga}  \textit{cˀjui}  \textit{joonasi}\\
    ...
    \textsc{mes}-\textsc{adnz}=\textsc{loc2}  old.man=\textsc{nom}  one.\textsc{clf}.person  pear
...
In the above example, the NP, i.e. \textit{u-n} \textit{cˀju} (\textsc{mes}-\textsc{adnz} person) ‘that person,’ is definite since it has the demonstrative \textit{u-n} (\textsc{mes}-\textsc{adnz}) ‘that (one)’ in the modifier slot. However, the plural marker that follows the NP is \textit{nkja} (\textsc{appr}), which is on the lowest position on the animacy hierarchy in Yuwan. In other words, such forms as *\textit{u-n} \textit{cˀju-kja} (\textsc{mes}-ADNZ person-\textsc{pl}) or *\textit{u-n} \textit{cˀju-taa} (\textsc{mes}-ADNZ person-PL) are not grammatical. However, the nominative case is sensitive to the definiteness of the whole NP, as discussed in \sectref{sec:key:6.4.3.6} (especially, see (\ref{ex:6-132}c)).
