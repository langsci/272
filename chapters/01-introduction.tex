...
\lsptoprule
 \textsc{id} & {First (Second) name} & {Family name} & {year of birth} & {period of absence}\\
          &                         &              &               &  {from Yuwan}\\\midrule
\textsc{tm} & Sachi (Tsuneko) & Motoda & {1923} & {14--21 years old}\\
\textsc{us} & Mine (Umine) & Shinozaki & {1917} & {15--52}\\
\textsc{my} & Sumie (Mutsu) & Yamaki & {1924} & {28--49}\\
\textsc{mt} & Mitsuko & Toshioka & {1934} & {24--26}\\
\textsc{ym} & Yetsue & Murano & {1935} & {Never}\\
\textsc{mm} & Masako & Motoda & {1939} & {15--38}\\
\textsc{nm} & Nobuari & Motoda & {1950} & {20--29}\\
\textsc{sm} & Sawako & Motoda & {1951} & {15--26}\\
\textsc{ms} & Mioya & Sunao & {1953} & {16--53}\\
\lspbottomrule
\end{tabular}}
\end{table}
