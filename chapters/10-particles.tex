...
\textit{kai} (\textsc{du}B) may be followed by the utterance-final particle B \textit{jaa} (\textsc{sol}). In that case, \textit{kai} (\textsc{dub}) may retain its form as in \REF{ex:10.50} and (10-51 a), or may lose one of its word-final vowel, i.e., become /ka/, as in (10-51 b).
